            ...
            $div = '<div class="row pb-3">';
                ...
                //
                    $div .= '<div class="row linhaPedidoItens font-weight-bold">';
                        $div .= '<div class="col-md-3 col-sm-3 d-none d-md-block">';
                            $div .= 'Produto';
                        $div .= '</div>';
                        $div .= '<div class="col-md-2 col-sm-2 d-none d-md-block text-right">';
                            $div .= 'Qte';
                        $div .= '</div>';
                        $div .= '<div class="col-md-2 col-sm-2 d-none d-md-block text-right">';
                            $div .= 'Unitário';
                        ...
                        $div .= '<div class="col-md-2 col-sm-2 d-none d-md-block text-right">';
                            $div .= 'Total';
                        $div .= '</div>';
                        $div .= '<div class="col-md-1 col-sm-1 d-none d-md-block text-right">';
                        $div .= '</div>';
                    $div .= '</div>';
                    //
                    foreach($res AS $reg){
                        $div .= '<div class="row border-prod">';
                            $div .= '<div class="col-md-3 col-sm-3 col-12 pt-2">';
                                ...
                                $div .= '</div>';
                            $div .= '</div>';
                            $div .= '<div class="col-md-2 col-sm-2 pt-2 d-none d-md-block text-right">';
                            ...
                            $div .= '</div>';
                            $div .= '<div class="col-md-1 col-sm-1 pt-2 d-none d-md-block text-right">';
            ...
            $div = '<div class="row pb-3">';
                ...
                //
                    $div .= '<div class="row linhaPedidoContas font-weight-bold">';
                        $div .= '<div class="col-md-1 col-sm-1 d-none d-md-block">';
                            $div .= 'Dias';
                        $div .= '</div>';
                        $div .= '<div class="col-md-2 col-sm-2 d-none d-md-block">';
                            $div .= 'Vencimento';
                        $div .= '</div>';
                        $div .= '<div class="col-md-2 col-sm-2 d-none d-md-block">';
                            $div .= 'Conta Bancaria';
                    ...
                    foreach($res AS $reg){
                        ...
                        $div .= '<div class="row border-prod">';
                            $div .= '<div class="col-md-1 col-sm-1 pt-2 d-none d-md-block">';
                                $div .= $reg['pcon_vencimento_dias'];
                            $div .= '</div>';
                            $div .= '<div class="col-md-2 col-sm-2 col-12 pt-2">';
                                ...
                                $div .= '</div>';
                            $div .= '</div>';
                            $div .= '<div class="col-md-2 col-sm-2 pt-2 d-none d-md-block">';
                                $div .= $reg['cc_nome'];
                            $div .= '</div>';
                            $div .= '<div class="col-md-2 col-sm-2 pt-2 d-none d-md-block">';
                                $div .= $reg['mpag_nome'];
                            $div .= '</div>';
                            $div .= '<div class="col-md-1 col-sm-1 pt-2 d-none d-md-block ' . $classePointer . '" ' . $functionAbreConta . '>';

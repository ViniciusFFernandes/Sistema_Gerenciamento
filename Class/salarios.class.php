...
class Salarios{
	...
	public function getFuncionarios($idsalarios){
		...
		foreach($res AS $reg){
			...
			//
			$linhaFuncionarios .= '<div class="row ' . $corLinha . '" style="padding-top: 5px; padding-bottom: 5px;">';
				...
				$linhaFuncionarios .= '<div class="col-md-2 col-sm-2 col-xs-2" style="padding-left: 0px;">';
					$linhaFuncionarios .= '<button type="button" class="btn btn-light"><img src="../icones/excluir2.png" width="15px;" onclick="excluirFuncionario(' . $reg['idsalarios_funcionarios'] . ')"></button>';
				$linhaFuncionarios .= '</div>';
			$linhaFuncionarios .= '</div>';
			//
			$linhas++;
